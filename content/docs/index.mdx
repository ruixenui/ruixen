---
title: Installation
description: Getting started with ruixen
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ruixen.com/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://ruixen.com/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ruixen.com/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ruixen.com/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ruixen.com/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ruixen.com/r/card-05.json
```
...
```jsx
import Card05 from "@/components/ruixen/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://ruixen.com/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://ruixen.com/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ruixen.com/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/ruixen/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://ruixen.com/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://ruixen.com/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ruixen.com/r/card-05.json -c ./apps/www
```
